...
from paddle.nn import Conv2D, BatchNorm, Flatten, BatchNorm1D
...
class MobileFaceNet(nn.Layer):
    def __init__(self, in_channels=3, scale=0.5):
        ...
        self.linear = Linear(in_features=int(1024 * scale), out_features=512)
        self.bn = BatchNorm1D(512, data_format='NC')
